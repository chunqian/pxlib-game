...
add_includedirs("$(projectdir)/pxtool/lib/libpng/include")
add_linkdirs("$(projectdir)/pxtool/lib/libpng/lib",
...
add_files("$(projectdir)/pxtool/pngtotraw/*.c")
add_files("$(projectdir)/pxtool/pngtotraw/*.cpp")

add_ldflags("-static-libgcc")
add_links("pxlib", "png", "bz2", "zlib")
