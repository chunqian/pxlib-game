    ...
    while (1) {
        ...
        while (PX_GetWinMessage(&msg)) {
            ...
            switch (msg.uMsg) {
                ...
                //                 if
                //                 (25>(main_zoomPoint.x-gi.ptsLocation.x)*(main_zoomPoint.x-gi.ptsLocation.x)+(main_zoomPoint.y-gi.ptsLocation.y)*(main_zoomPoint.y-gi.ptsLocation.y))
                //                 {
...
#define REMOTESHELL_PROCESS_GUID ("startup_server")
HANDLE G_hMutex;
