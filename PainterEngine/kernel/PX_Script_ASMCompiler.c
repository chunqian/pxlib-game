...
static px_void PX_ScriptAsmRegistInstr(PX_SCRIPT_ASM_COMPILER *compiler, px_char mnemonic[__PX_SCRIPT_ASM_INSTR_MNEMONIC_NAME_LEN], px_char opcode,
                                       px_int accType[], px_char paramcout) {
    px_int i = 0;
    ...
    for (i = 0; i < PX_strlen(str->buffer); i++) {
        if (str->buffer[i] == '\\') {
            switch (str->buffer[i + 1]) {
                case '\\':
                    for (j = i + 1; str->buffer[j]; j++) str->buffer[j] = str->buffer[j + 1];
                    str->buffer[j - 1] = 0;
                    break;
                case 'r':
                case 'R':
...
px_bool PX_ScriptAsmAddMemoryConst(PX_SCRIPT_ASM_COMPILER *compiler, px_char *StringMap) {
    ...
    if (!PX_MemoryAlloc(&memoryNode.mem, PX_strlen(StringMap) >> 1)) return PX_FALSE;
...
static px_void PX_ScriptAsmRegistInstr_1(PX_SCRIPT_ASM_COMPILER *compiler, px_char mnemonic[__PX_SCRIPT_ASM_INSTR_MNEMONIC_NAME_LEN], px_char opcode,
                                         px_int accType1) {
    PX_ScriptAsmRegistInstr(compiler, mnemonic, opcode, &accType1, 1);
}

static px_void PX_ScriptAsmRegistInstr_2(PX_SCRIPT_ASM_COMPILER *compiler, px_char mnemonic[__PX_SCRIPT_ASM_INSTR_MNEMONIC_NAME_LEN], px_char opcode,
                                         px_int accType1, px_int accType2) {
    px_int accType[2];
    accType[0] = accType1;
    accType[1] = accType2;
...
static px_void PX_ScriptAsmRegistInstr_3(PX_SCRIPT_ASM_COMPILER *compiler, px_char mnemonic[__PX_SCRIPT_ASM_INSTR_MNEMONIC_NAME_LEN], px_char opcode,
                                         px_int accType1, px_int accType2, px_int accType3) {
    px_int accType[3];
    accType[0] = accType1;
    accType[1] = accType2;
    accType[2] = accType3;
...
px_bool PX_ScriptAsmCompile(px_memorypool *mp, px_char *asmcode, px_memory *binmemory) {
    ...
    PX_ScriptAsmRegistInstr_2(&compiler, "MOV", PX_SCRIPT_ASM_INSTR_OPCODE_MOV,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_BP | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_SP | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_IP,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_BP | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_SP |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_IP | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_MEMORY | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING);
    ...
    PX_ScriptAsmRegistInstr_2(
        &compiler, "SUB", PX_SCRIPT_ASM_INSTR_OPCODE_SUB,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_BP |
    ...
    PX_ScriptAsmRegistInstr_2(
        &compiler, "DIV", PX_SCRIPT_ASM_INSTR_OPCODE_DIV,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "MUL", PX_SCRIPT_ASM_INSTR_OPCODE_MUL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "MOD", PX_SCRIPT_ASM_INSTR_OPCODE_MOD,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
    ...
    PX_ScriptAsmRegistInstr_2(
        &compiler, "SHL", PX_SCRIPT_ASM_INSTR_OPCODE_SHL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "SHR", PX_SCRIPT_ASM_INSTR_OPCODE_SHR,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "AND", PX_SCRIPT_ASM_INSTR_OPCODE_AND,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "ANDL", PX_SCRIPT_ASM_INSTR_OPCODE_ANDL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "ORL", PX_SCRIPT_ASM_INSTR_OPCODE_ORL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "OR", PX_SCRIPT_ASM_INSTR_OPCODE_OR,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "XOR", PX_SCRIPT_ASM_INSTR_OPCODE_XOR,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "POW", PX_SCRIPT_ASM_INSTR_OPCODE_POW,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);
    PX_ScriptAsmRegistInstr_2(
        &compiler, "SIN", PX_SCRIPT_ASM_INSTR_OPCODE_SIN,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "COS", PX_SCRIPT_ASM_INSTR_OPCODE_COS,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);
    ...
    PX_ScriptAsmRegistInstr_3(
        &compiler, "STRCHR", PX_SCRIPT_ASM_INSTR_OPCODE_STRCHR,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
            PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING,
    ...
    PX_ScriptAsmRegistInstr_2(
        &compiler, "STRFRI", PX_SCRIPT_ASM_INSTR_OPCODE_STRFRI,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);
    ...
    PX_ScriptAsmRegistInstr_3(
        &compiler, "STRSET", PX_SCRIPT_ASM_INSTR_OPCODE_STRSET,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT |
            PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING);
    ...
    PX_ScriptAsmRegistInstr_3(
        &compiler, "MEMBYTE", PX_SCRIPT_ASM_INSTR_OPCODE_MEMBYTE,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
    ...
    PX_ScriptAsmRegistInstr_3(
        ...
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL);
    PX_ScriptAsmRegistInstr_3(
        &compiler, "MEMTRM", PX_SCRIPT_ASM_INSTR_OPCODE_MEMTRM,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);
    ...
    PX_ScriptAsmRegistInstr_3(
        &compiler, "DATACPY", PX_SCRIPT_ASM_INSTR_OPCODE_DATACPY,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);
    ...
    PX_ScriptAsmRegistInstr_1(&compiler, "JMP", PX_SCRIPT_ASM_INSTR_OPCODE_JMP,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LABEL);

    PX_ScriptAsmRegistInstr_3(&compiler, "JE", PX_SCRIPT_ASM_INSTR_OPCODE_JE,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LABEL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);
    ...
    PX_ScriptAsmRegistInstr_1(&compiler, "CALL", PX_SCRIPT_ASM_INSTR_OPCODE_CALL,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LABEL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_HOST);

    PX_ScriptAsmRegistInstr_1(&compiler, "PUSH", PX_SCRIPT_ASM_INSTR_OPCODE_PUSH,
                              PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL |
                                  PX_SCRIPT_ASM_OPERAND_ACC_TYPE_NUM | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LABEL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_STRING |
    ...
    PX_ScriptAsmRegistInstr_1(
        &compiler, "WAIT", PX_SCRIPT_ASM_INSTR_OPCODE_WAIT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);

    PX_ScriptAsmRegistInstr_2(
        &compiler, "SIGNAL", PX_SCRIPT_ASM_INSTR_OPCODE_SIGNAL,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT,
        PX_SCRIPT_ASM_OPERAND_ACC_TYPE_REG | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_LOCAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_GLOBAL | PX_SCRIPT_ASM_OPERAND_ACC_TYPE_INT);
    ...
    if (!PX_ScriptAsmScan(&compiler)) goto __ERROR;
    PX_LexerSetState(lexerstate);
    if (!PX_ScriptAsmCc(&compiler)) goto __ERROR;
