...
px_void Game_Object_ProtectShieldRender(px_surface *psurface, PX_Object *pObject, px_dword elpased) {
    ...
    if (pDesc->elpased <= 500) {
        ...
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2 * scale), 5, PX_COLOR(255, 192, 0, 0),
                       (px_uint)pDesc->angle, (px_uint)pDesc->angle + 60);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2 * scale), 5, PX_COLOR(255, 192, 0, 0),
                       (px_uint)pDesc->angle + 120, (px_uint)pDesc->angle + 180);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2 * scale), 5, PX_COLOR(255, 192, 0, 0),
                       (px_uint)pDesc->angle + 240, (px_uint)pDesc->angle + 300);
        ...
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR((px_uchar)(scale * 255), 192, 0, 0),
                       (px_uint)pDesc->angle, (px_uint)pDesc->angle + 60);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR((px_uchar)(scale * 255), 192, 0, 0),
                       (px_uint)pDesc->angle + 120, (px_uint)pDesc->angle + 180);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR((px_uchar)(scale * 255), 192, 0, 0),
        ...
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR(255, 192, 0, 0), (px_uint)pDesc->angle,
                       (px_uint)pDesc->angle + 60);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR(255, 192, 0, 0),
                       (px_uint)pDesc->angle + 120, (px_uint)pDesc->angle + 180);
        PX_GeoDrawRing(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->diameter / 2), 5, PX_COLOR(255, 192, 0, 0),
                       (px_uint)pDesc->angle + 240, (px_uint)pDesc->angle + 300);
    }
