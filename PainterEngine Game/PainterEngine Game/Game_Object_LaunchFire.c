...
PX_Object *Game_Object_LaunchFireCreateObject(PX_Instance *pIns, PX_World *pWorld, PX_ParticalLauncher_InitializeInfo init_info, px_point position,
                                              px_point direction, px_point velocity, px_dword alive) {
