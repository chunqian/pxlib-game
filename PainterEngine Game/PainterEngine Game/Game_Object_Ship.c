...
Game_Object_Ship *Game_Object_GetShip(PX_Object *pObject) { return (Game_Object_Ship *)pObject->pObject; }
...
px_void Game_Object_ShipRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    if (PX_PointSquare(direction)) {
        PX_TextureRenderRotation_vector(psurface, pShip->shipObject, (px_int)pObject->x, (px_int)pObject->y, PX_TEXTURERENDER_REFPOINT_CENTER, PX_NULL,
                                        direction);
    } else {
...
px_void Game_Object_ShipAddWeapon(PX_Object *pObject, GAME_OBJECT_SHIP_WEAPON_TYPE type, px_int atomCount, px_dword fireDuration, px_int maxCount,
                                  px_dword turretType) {
    px_int i;
    ...
    if (e.Event == GAME_OBJECT_EVENT_ADDWEAPON) {
        switch (type) {
            case GAME_OBJECT_SHIP_WEAPON_TYPE_BLACKHOLE:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_BLACKHOLE, count, GAME_OBJECT_SHIP_WEAPON_BLACKHOLE_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_BLACKHOLE_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_LAUNCHER);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_MACHINEGUN:
                ...
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_MACHINEGUN, 1000, GAME_OBJECT_SHIP_WEAPON_MACHINEGUN_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_MACHINEGUN_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_GUN);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_MINE:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_MINE, count, GAME_OBJECT_SHIP_WEAPON_MINE_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_MINE_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_LAUNCHER);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_MISSILE:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_MISSILE, count, GAME_OBJECT_SHIP_WEAPON_MISSILE_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_MISSILE_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_MISSILE);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_NUCLEAR:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_NUCLEAR, count, GAME_OBJECT_SHIP_WEAPON_NUCLEAR_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_NUCLEAR_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_LAUNCHER);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_RAILGUN:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_RAILGUN, count, GAME_OBJECT_SHIP_WEAPON_RAILGUN_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_RAILGUN_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_CHARGER);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_PROTECTSHIELD:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_PROTECTSHIELD, count, GAME_OBJECT_SHIP_WEAPON_PROTECTSHIELD_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_PROTECTSHIELD_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_CHARGER);
                break;
            case GAME_OBJECT_SHIP_WEAPON_TYPE_PIERCER:
                Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_PIERCER, count, GAME_OBJECT_SHIP_WEAPON_PIERCER_DURATION,
                                          GAME_OBJECT_SHIP_WEAPON_PIERCER_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_GUN);
                break;
        }
    }
}
...
PX_Object *Game_Object_ShipCreate(PX_Instance *pIns, PX_World *pWorld, Game_Object_ShipDescription desc) {
    ...
    Game_Object_ShipAddWeapon(pObject, GAME_OBJECT_SHIP_WEAPON_TYPE_MACHINEGUN, 0, GAME_OBJECT_SHIP_WEAPON_MACHINEGUN_DURATION,
                              GAME_OBJECT_SHIP_WEAPON_MACHINEGUN_MAX_CARGO, GAME_OBJECT_PLUGIN_TURRET_TYPE_GUN);
