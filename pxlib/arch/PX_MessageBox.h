...
typedef enum { PX_MESSAGEBOX_MODE_EXPAND, PX_MESSAGEBOX_MODE_CLOSE } PX_MESSAGEBOX_MODE;

typedef enum { PX_MESSAGEBOX_RETURN_NONE, PX_MESSAGEBOX_RETURN_YES, PX_MESSAGEBOX_RETURN_NO } PX_MESSAGEBOX_RETURN;
