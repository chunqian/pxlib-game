...
px_bool PX_RuntimeInitialize(PX_Runtime *pe, px_int surface_width, px_int surface_height, px_void *runtime_memoryPtr, px_uint size, px_uint ui_size,
                             px_uint resource_size, px_uint game_size);
