...
extern void rb_augment_insert(struct px_rb_node *node, rb_augment_f func, void *data);
extern struct px_rb_node *rb_augment_erase_begin(struct px_rb_node *node);
extern void rb_augment_erase_end(struct px_rb_node *node, rb_augment_f func, void *data);
