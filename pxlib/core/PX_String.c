...
px_void PX_StringFree(px_string *str) {
    if (str->buffer && str->bufferlen) MP_Free(str->mp, str->buffer);
...
px_bool PX_StringFormat7(px_string *str, const px_char fmt[], px_stringformat _1, px_stringformat _2, px_stringformat _3, px_stringformat _4,
...
px_bool PX_StringFormat6(px_string *str, const px_char fmt[], px_stringformat _1, px_stringformat _2, px_stringformat _3, px_stringformat _4,
...
px_bool PX_StringFormat5(px_string *str, const px_char fmt[], px_stringformat _1, px_stringformat _2, px_stringformat _3, px_stringformat _4,
                         px_stringformat _5) {
...
px_bool PX_StringFormat3(px_string *str, const px_char fmt[], px_stringformat _1, px_stringformat _2, px_stringformat _3) {
    return PX_StringFormat8(str, fmt, _1, _2, _3, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                            PX_STRINGFORMAT_INT(0));
}

px_bool PX_StringFormat2(px_string *str, const px_char fmt[], px_stringformat _1, px_stringformat _2) {
    return PX_StringFormat8(str, fmt, _1, _2, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
                            PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0));
}

px_bool PX_StringFormat1(px_string *str, const px_char fmt[], px_stringformat _1) {
    return PX_StringFormat8(str, fmt, _1, PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0), PX_STRINGFORMAT_INT(0),
...
px_float PX_StringToFloat(px_string *str) { return PX_atof(PX_STRING_DATA(str)); }

px_bool PX_StringIsNumeric(px_string *str) { return PX_strIsNumeric(str->buffer); }
...
px_bool PX_StringCat(px_string *str, const px_char *str2) {
    ...
    PX_strcat(str->buffer, str2);
    if (old) MP_Free(str->mp, old);
    return PX_TRUE;
}

px_void PX_StringClear(px_string *str) { str->buffer[0] = '\0'; }
