...
px_bool PX_TextureCreate(px_memorypool *mp, px_texture *tex, px_int width, px_int height) { return PX_SurfaceCreate(mp, width, height, tex); }
...
px_void PX_TextureCover(px_surface *psurface, px_texture *tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint) {
    ...
    for (j = top; j <= bottom; j++) {
        PX_memcpy(&psurface->surfaceBuffer[x + left + psurface->width * (y + j)], &tex->surfaceBuffer[tex->width * (j) + left],
                  sizeof(px_color) * (right - left + 1));
    }
}

px_void PX_TextureRenderRotation(px_surface *psurface, px_texture *tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint, PX_TEXTURERENDER_BLEND *blend,
                                 px_int Angle) {
    PX_TextureRenderRotation_sincos(psurface, tex, x, y, refPoint, blend, PX_sin_angle((px_float)Angle), PX_cos_angle((px_float)Angle));
}

px_void PX_TextureRenderRotation_vector(px_surface *psurface, px_texture *tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                                        PX_TEXTURERENDER_BLEND *blend, px_point p_vector) {
    PX_TextureRenderRotation_sincos(psurface, tex, x, y, refPoint, blend, PX_Point_sin(p_vector), PX_Point_cos(p_vector));
}

px_void PX_TextureRenderRotation_sincos(px_surface *psurface, px_texture *tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                                        PX_TEXTURERENDER_BLEND *blend, px_float sinx, px_float cosx) {
...
px_void PX_TextureRenderMask(px_surface *psurface, px_texture *mask_tex, px_texture *map_tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                             PX_TEXTURERENDER_BLEND *blend) {
    px_int left, right, top, bottom, i, j;
    px_int bR, bG, bB, bA;
...
px_void PX_TextureRenderEx(px_surface *psurface, px_texture *resTexture, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint, PX_TEXTURERENDER_BLEND *blend,
                           px_float scale, px_float Angle) {
...
px_void PX_TextureRenderMaskEx(px_surface *psurface, px_texture *mask_tex, px_texture *map_tex, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                               PX_TEXTURERENDER_BLEND *blend, px_float scale, px_float Angle) {
    px_int newWidth, newHeight;
...
px_void PX_ShapeRenderEx(px_surface *psurface, px_shape *shape, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint, px_color blendColor, px_float scale,
                         px_float Angle) {
    px_int newWidth, newHeight;
...
px_void PX_ShapeRenderEx_sincos(px_surface *psurface, px_shape *shape, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint, px_color blendColor,
                                px_float scale, px_float sinx, px_float cosx) {
    px_int newWidth, newHeight;
...
px_void PX_ShapeRenderEx_vector(px_surface *psurface, px_shape *shape, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint, px_color blendColor,
                                px_float scale, px_point p_vector) {
    PX_ShapeRenderEx_sincos(psurface, shape, x, y, refPoint, blendColor, scale, PX_Point_sin(p_vector), PX_Point_cos(p_vector));
}

px_void PX_TextureRenderEx_sincos(px_surface *psurface, px_texture *resTexture, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                                  PX_TEXTURERENDER_BLEND *blend, px_float scale, px_float sinx, px_float cosx) {
    px_int newWidth, newHeight;
...
px_void PX_TextureRenderEx_vector(px_surface *psurface, px_texture *resTexture, px_int x, px_int y, PX_TEXTURERENDER_REFPOINT refPoint,
                                  PX_TEXTURERENDER_BLEND *blend, px_float scale, px_point p_vector) {
