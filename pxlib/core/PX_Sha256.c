...
#define STORE32H(x, y)                          \
    {                                           \
        (y)[0] = (px_uchar)(((x) >> 24) & 255); \
        (y)[1] = (px_uchar)(((x) >> 16) & 255); \
        (y)[2] = (px_uchar)(((x) >> 8) & 255);  \
        (y)[3] = (px_uchar)((x)&255);           \
    }

#define LOAD32H(x, y) \
    { x = ((px_uint32)((y)[0] & 255) << 24) | ((px_uint32)((y)[1] & 255) << 16) | ((px_uint32)((y)[2] & 255) << 8) | ((px_uint32)((y)[3] & 255)); }

#define STORE64H(x, y)                          \
    {                                           \
        (y)[0] = (px_uchar)(((x) >> 56) & 255); \
        (y)[1] = (px_uchar)(((x) >> 48) & 255); \
        (y)[2] = (px_uchar)(((x) >> 40) & 255); \
        (y)[3] = (px_uchar)(((x) >> 32) & 255); \
        (y)[4] = (px_uchar)(((x) >> 24) & 255); \
        (y)[5] = (px_uchar)(((x) >> 16) & 255); \
        (y)[6] = (px_uchar)(((x) >> 8) & 255);  \
        (y)[7] = (px_uchar)((x)&255);           \
    }
