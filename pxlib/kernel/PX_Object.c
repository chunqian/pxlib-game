...
PX_Object *PX_ObjectCreateEx(px_memorypool *mp, PX_Object *Parent, px_float x, px_float y, px_float z, px_float Width, px_float Height, px_float Lenght,
                             px_int type, Function_ObjectUpdate Func_ObjectUpdate, Function_ObjectRender Func_ObjectRender, Function_ObjectFree Func_ObjectFree,
                             px_void *desc, px_int size) {
...
static px_void PX_Object_ObjectFree(PX_Object *Object) {
    ...
    if (Object->pObject) MP_Free(Object->mp, Object->pObject);
    ...
    if (pObject->pParent != PX_NULL) {
        if (pObject->pParent->pChilds == pObject) {
            ...
            if (pObject->pPreBrother != PX_NULL) {
                ...
                if (pObject->pNextBrother) pObject->pNextBrother->pPreBrother = pObject->pPreBrother;
            } else {
...
px_void PX_ObjectInit(px_memorypool *mp, PX_Object *pObject, PX_Object *Parent, px_float x, px_float y, px_float z, px_float Width, px_float Height,
                      px_float Lenght) {
    PX_Object *pLinker;
...
px_void PX_Object_LabelRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                   (px_int)pObject->y + (px_int)pObject->Height - 1, pLabel->BackgroundColor);

    if (pLabel->Border) {
        PX_GeoDrawBorder(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                         (px_int)pObject->y + (px_int)pObject->Height - 1, 1, pLabel->TextColor);
    }
...
px_void PX_Object_ProcessBarRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    // Draw BackGround
    PX_SurfaceClear(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                    (px_int)pObject->y + (px_int)pObject->Height - 1, pProcessBar->BackgroundColor);
    // Draw border
    PX_GeoDrawBorder(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                     (px_int)pObject->y + (px_int)pObject->Height - 1, 1, pProcessBar->Color);
        ...
        if (PX_ObjectIsPointInRegion(pObject, (px_float)x, (px_float)y)) {
            ...
            if (pSliderBar->Type == PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL) {
                switch (pSliderBar->style) {
                    case PX_OBJECT_SLIDERBAR_STYLE_LINER: {
                        Sx =
                            (px_int)pObject->x + (px_int)((pObject->Width - 4 - pSliderBar->SliderButtonLength) * (1.0f) * pSliderBar->Value / pSliderBar->Max);
            ...
            if (pSliderBar->Type == PX_OBJECT_SLIDERBAR_TYPE_VERTICAL) {
                switch (pSliderBar->style) {
                    ...
                    case PX_OBJECT_SLIDERBAR_STYLE_BOX: {
                        Sy = (px_int)pObject->y +
                             (px_int)((pObject->Height - 4 - pSliderBar->SliderButtonLength) * (1.0f) * pSliderBar->Value / pSliderBar->Max);
...
PX_Object *PX_Object_SliderBarCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int Width, px_int Height, enum PX_OBJECT_SLIDERBAR_TYPE Type,
...
px_void PX_Object_SliderBarRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    // Clear
    PX_SurfaceClear(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                    (px_int)pObject->y + (px_int)pObject->Height - 1, pSliderBar->BackgroundColor);
            ...
            if (pSliderBar->Type == PX_OBJECT_SLIDERBAR_TYPE_HORIZONTAL) {
                switch (pSliderBar->style) {
                    case PX_OBJECT_SLIDERBAR_STYLE_LINER: {
                        ...
                        Sy = (px_int)pObject->y;
                        // Draw Line
                        PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y + (px_int)pObject->Height / 2,
                                       (px_int)pObject->x + (px_int)pObject->Width - 1, (px_int)pObject->y + (px_int)pObject->Height / 2, pSliderBar->color);
                        // Draw Slider button
                    ...
                    case PX_OBJECT_SLIDERBAR_STYLE_BOX: {
                        // draw border
                        PX_GeoDrawBorder(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                         (px_int)pObject->y + (px_int)pObject->Height - 1, 1, pSliderBar->color);
                        Sx = (px_int)((pObject->Width - 4 - pSliderBar->SliderButtonLength) * (1.0f) * pSliderBar->Value / pSliderBar->Max);
                        pSliderBar->DargButtonX = Sx;
                        Sx += SliderBtnLen / 2;
                        // draw slider bar
                        PX_GeoDrawRect(psurface, (px_int)pObject->x + Sx - SliderBtnLen / 2 + 2, (px_int)pObject->y + 2,
                                       (px_int)pObject->x + Sx - SliderBtnLen / 2 + SliderBtnLen - 1, (px_int)pObject->y + (px_int)pObject->Height - 3,
                                       pSliderBar->color);
                    } break;
                }
            }
            ...
            if (pSliderBar->Type == PX_OBJECT_SLIDERBAR_TYPE_VERTICAL) {
                switch (pSliderBar->style) {
                    case PX_OBJECT_SLIDERBAR_STYLE_LINER: {
                        ...
                        Sy += (px_int)pObject->y;
                        // Draw Line
                        PX_GeoDrawRect(psurface, (px_int)pObject->x + (px_int)pObject->Width / 2, (px_int)pObject->y,
                                       (px_int)pObject->x + (px_int)pObject->Width / 2, (px_int)pObject->y + (px_int)pObject->Height - 1, pSliderBar->color);
                        // Draw Slider button
                    ...
                    case PX_OBJECT_SLIDERBAR_STYLE_BOX: {
                        ...
                        Sy += SliderBtnLen / 2;
                        // draw slider bar
                        PX_GeoDrawRect(psurface, (px_int)pObject->x + 2, (px_int)pObject->y + Sy - SliderBtnLen / 2 + 2,
                                       (px_int)pObject->x + (px_int)pObject->Width - 1 - 2, (px_int)pObject->y + Sy + SliderBtnLen / 2 - 1 + 1,
                                       pSliderBar->color);
                    } break;
                }
            }
            ...
            if (pSliderBar->Type == PX_OBJECT_SLIDERBAR_TYPE_VERTICAL) {
                switch (pSliderBar->style) {
                    ...
                    case PX_OBJECT_SLIDERBAR_STYLE_BOX: {
                        ...
                        // draw slider bar
                        PX_GeoDrawRect(psurface, (px_int)pObject->x + 2, (px_int)pObject->y + Sy - SliderBtnLen / 2 + 2,
                                       (px_int)pObject->x + (px_int)pObject->Width - 1 - 2, (px_int)pObject->y + Sy + SliderBtnLen / 2 - 1 + 2,
                                       pSliderBar->color);
                    } break;
                }
            }
...
px_void PX_Object_PushButtonOnMouseLButtonDown(PX_Object *Object, PX_Object_Event e, px_void *user_ptr) {
    ...
    if (pPushButton) {
        if (PX_ObjectIsPointInRegion(Object, (px_float)x, (px_float)y)) pPushButton->state = PX_OBJECT_BUTTON_STATE_ONPUSH;
    }
}
...
px_void PX_Object_PushButtonRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    switch (pPushButton->style) {
        case PX_OBJECT_PUSHBUTTON_STYLE_RECT:
            PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                           (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->BackgroundColor);
            switch (pPushButton->state) {
                ...
                case PX_OBJECT_BUTTON_STATE_ONPUSH:
                    PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                   (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->PushColor);
                    break;
                case PX_OBJECT_BUTTON_STATE_ONCURSOR:
                    PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                   (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->CursorColor);
                    break;
            }
            break;
        case PX_OBJECT_PUSHBUTTON_STYLE_ROUNDRECT:
            PX_GeoDrawSolidRoundRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                     (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->roundradius, pPushButton->BackgroundColor);
            switch (pPushButton->state) {
                case PX_OBJECT_BUTTON_STATE_NORMAL:
                    PX_GeoDrawSolidRoundRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                             (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->roundradius, pPushButton->BackgroundColor);
                ...
                case PX_OBJECT_BUTTON_STATE_ONPUSH:
                    PX_GeoDrawSolidRoundRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                             (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->roundradius, pPushButton->PushColor);
                    break;
                case PX_OBJECT_BUTTON_STATE_ONCURSOR:
                    PX_GeoDrawSolidRoundRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                             (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->roundradius, pPushButton->CursorColor);
                    break;
            }
            break;
    }
    ...
    if (pPushButton->Texture) {
        PX_TextureRender(psurface, pPushButton->Texture, (px_int)pObject->x + (px_int)pObject->Width / 2, (px_int)pObject->y + (px_int)pObject->Height / 2,
                         PX_TEXTURERENDER_REFPOINT_CENTER, PX_NULL);
    } else if (pPushButton->shape) {
        PX_ShapeRender(psurface, pPushButton->shape, (px_int)pObject->x + (px_int)pObject->Width / 2, (px_int)pObject->y + (px_int)pObject->Height / 2,
                       PX_TEXTURERENDER_REFPOINT_CENTER, pPushButton->TextColor);
    }
    ...
    if (pPushButton->Border) {
        switch (pPushButton->style) {
            case PX_OBJECT_PUSHBUTTON_STYLE_RECT:
                PX_GeoDrawBorder(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                 (px_int)pObject->y + (px_int)pObject->Height - 1, 1, pPushButton->BorderColor);
                break;
            case PX_OBJECT_PUSHBUTTON_STYLE_ROUNDRECT:
                PX_GeoDrawRoundRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                                    (px_int)pObject->y + (px_int)pObject->Height - 1, pPushButton->roundradius, 0.6f, pPushButton->BorderColor);
                break;
        }
    }
...
px_void PX_Object_RotationRender(px_surface *psurface, PX_Object *Obj, px_uint elpased) {
    ...
    if (pRot) {
        if (!pRot->bstop) pRot->angle += (pRot->angle_per_second * (elpased / 1000.0f));
...
px_void PX_Object_EditRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    } else if (pEdit->onFocus && pEdit->cursor_index == charIndex) {
        x_draw_oft = x - pEdit->XOffset;
        y_draw_oft = y - pEdit->YOffset;

        pEdit->elpased += elpased;
        if ((pEdit->elpased / 200) & 1) {
            PX_GeoDrawRect(&pEdit->EditSurface, x_draw_oft, y_draw_oft, x_draw_oft + __PX_FONT_ASCSIZE - 1, y_draw_oft + __PX_FONT_HEIGHT - 1,
                           pEdit->CursorColor);
        }
    }
...
px_void PX_Object_ScrollArea_EventDispatcher(PX_Object *Object, PX_Object_Event e, px_void *user_ptr) {
    ...
    if (e.Event == PX_OBJECT_EVENT_EXECUTE || e.Event == PX_OBJECT_EVENT_CURSORDRAG || e.Event == PX_OBJECT_EVENT_CURSORDOWN ||
        e.Event == PX_OBJECT_EVENT_CURSORUP || e.Event == PX_OBJECT_EVENT_CURSORMOVE) {
...
px_void PX_Object_ScrollAreaRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    // Draw Border
    if (pSA->bBorder) PX_GeoDrawBorder(&pSA->surface, 0, 0, (px_int)pObject->Width - 1, (px_int)pObject->Height - 1, 1, pSA->borderColor);
    PX_SurfaceRender(psurface, &pSA->surface, (px_int)pObject->x, (px_int)pObject->y, PX_TEXTURERENDER_REFPOINT_LEFTTOP, PX_NULL);
}
...
px_void PX_Object_AnimationFree(PX_Object *pObj) {
    PX_Object_Animation *pA = PX_Object_GetAnimation(pObj);
    if (pA) PX_AnimationFree(&pA->animation);
}

PX_Object *PX_Object_ParticalCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int z, px_texture *pTexture, PX_ScriptVM_Instance *pIns,
                                    px_char *Initfunc, px_char *_create, px_char *_update) {
    PX_Object *pObject;
...
px_void PX_ObjectSetUserCode(PX_Object *pObject, px_int user) { pObject->User_int = user; }

px_void PX_ObjectSetUserPointer(PX_Object *pObject, px_void *user_ptr) { pObject->User_ptr = user_ptr; }
...
px_void PX_Object_RoundCursorRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    if (pRoundCursor) {
        ...
        if (vector_x * vector_x + vector_y * vector_y) {
            ...
            vector_x *= sqrt_rec;
            vector_y *= sqrt_rec;
            PX_ShapeRenderEx_sincos(psurface, pRoundCursor->shape, (px_int)pObject->x, (px_int)pObject->y, PX_TEXTURERENDER_REFPOINT_CENTER,
                                    pRoundCursor->blendColor, 1.0f, -vector_x, -vector_y);
        }
    }
}
...
px_void PX_Object_ListClear(PX_Object *pListObj) {
    ...
    if (pList) PX_VectorClear(&pList->pData);
}
...
PX_Object *PX_Object_ListCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int Width, px_int Height, px_int ItemHeight,
    ...
    if (!(pListObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width, (px_float)Height, 0, PX_OBJECT_TYPE_LIST,
                                          PX_Object_ListUpdate, PX_Object_ListRender, PX_Object_ListFree, &List, sizeof(PX_Object_List))))
        return PX_NULL;

    pList = PX_Object_GetList(pListObject);
    pList->SliderBar = PX_Object_SliderBarCreate(mp, pListObject, (px_int)pListObject->Width - 32, 0, 32, (px_int)pListObject->Height,
                                                 PX_OBJECT_SLIDERBAR_TYPE_VERTICAL, PX_OBJECT_SLIDERBAR_STYLE_BOX);

    for (i = 0; i < Height / ItemHeight + 2; i++) {
        pItemObject = PX_ObjectCreateEx(mp, PX_NULL, 0, 0, 0, (px_float)pListObject->Width - 32, (px_float)ItemHeight, 0, PX_OBJECT_TYPE_LISTITEM, PX_NULL,
                                        PX_NULL, PX_NULL, &Item, sizeof(PX_Object_ListItem));
...
px_void PX_Object_VirtualKeyBoardRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    // clear background
    PX_SurfaceClear(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)(pObject->x + pObject->Width), (px_int)(pObject->y + pObject->Height),
    ...
    for (i = 0; i < PX_COUNTOF(keyBoard->Keys); i++) {
        ...
        if (keyBoard->Keys[i].bDown || keyBoard->Keys[i].bhold) {
            PX_GeoDrawRect(psurface, oftx + keyBoard->Keys[i].x, ofty + keyBoard->Keys[i].y, oftx + keyBoard->Keys[i].x + keyBoard->Keys[i].width,
                           ofty + keyBoard->Keys[i].y + keyBoard->Keys[i].height, keyBoard->pushColor);
        } else if (keyBoard->Keys[i].bCursor) {
            PX_GeoDrawRect(psurface, oftx + keyBoard->Keys[i].x, ofty + keyBoard->Keys[i].y, oftx + keyBoard->Keys[i].x + keyBoard->Keys[i].width,
                           ofty + keyBoard->Keys[i].y + keyBoard->Keys[i].height, keyBoard->cursorColor);
        }

        PX_GeoDrawBorder(psurface, oftx + keyBoard->Keys[i].x, ofty + keyBoard->Keys[i].y, oftx + keyBoard->Keys[i].x + keyBoard->Keys[i].width,
                         ofty + keyBoard->Keys[i].y + keyBoard->Keys[i].height, 1, keyBoard->borderColor);

        if (keyBoard->bShift || keyBoard->bUpper) {
            PX_FontDrawText(psurface, oftx + keyBoard->Keys[i].x + 2, ofty + keyBoard->Keys[i].y + 2, keyBoard->Keys[i].u_key, keyBoard->borderColor,
                            PX_FONT_ALIGN_XLEFT);
        } else {
            PX_FontDrawText(psurface, oftx + keyBoard->Keys[i].x + 2, ofty + keyBoard->Keys[i].y + 2, keyBoard->Keys[i].d_key, keyBoard->borderColor,
                            PX_FONT_ALIGN_XLEFT);
        }
    }
}
    ...
    for (i = 0; i < PX_COUNTOF(pkb->Keys); i++) {
        if (!pkb->Keys[i].bDown) {
            ...
            if (!PX_isPointInRect(PX_POINT((px_float)x, (px_float)y, 0),
                                  PX_RECT((px_float)pkb->Keys[i].x, (px_float)pkb->Keys[i].y, (px_float)pkb->Keys[i].width, (px_float)pkb->Keys[i].height)))
                pkb->Keys[i].bDown = PX_FALSE;
        }
    }
...
PX_Object *PX_Object_VirtualKeyBoardCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int width, px_int height) {
    ...
    keyboardObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)width, (px_float)height, 0, PX_OBJECT_TYPE_VKEYBOARD, PX_NULL,
                                       PX_Object_VirtualKeyBoardRender, PX_NULL, &keyboard, sizeof(PX_Object_VirtualKeyBoard));
...
static px_void PX_Object_CoordinatesDrawFrameLine(px_surface *psurface, PX_Object *pObject) {
    ...
    PX_GeoDrawLine(psurface, offsetx + pcd->LeftSpacer, offsety + pcd->TopSpacer, offsetx + (px_int)(pObject->Width - pcd->RightSpacer),
                   offsety + pcd->TopSpacer, PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH, pcd->borderColor);
    PX_GeoDrawLine(psurface, offsetx + pcd->LeftSpacer, offsety + pcd->TopSpacer, offsetx + pcd->LeftSpacer,
                   offsety + (px_int)(pObject->Height - pcd->BottomSpacer), PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH, pcd->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + pObject->Width - pcd->RightSpacer), offsety + (px_int)(pObject->Height - pcd->BottomSpacer),
                   offsetx + (pcd->LeftSpacer), offsety + (px_int)pObject->Height - pcd->BottomSpacer, PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH,
                   pcd->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + pObject->Width - pcd->RightSpacer), offsety + (px_int)(pObject->Height - pcd->BottomSpacer),
                   offsetx + (px_int)(pObject->Width - pcd->RightSpacer), offsety + pcd->TopSpacer, PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH,
                   pcd->borderColor);
}
...
static px_void PX_Object_CoordinatesDrawDashed(px_surface *psurface, PX_Object *pObject) {
    ...
    if (Divid > 1) {
        ...
        if (pcd->guidesShowMode == PX_OBJECT_COORDINATES_GUIDESSHOWMODE_ALL || pcd->guidesShowMode == PX_OBJECT_COORDINATES_GUIDESSHOWMODE_HORIZONTAL) {
            for (i = 1; i <= Divid; i++) {
                PX_GeoDrawLine(psurface, offsetx + (px_int)(pcd->LeftSpacer + i * HorizontalInc), offsety + pcd->TopSpacer,
                               offsetx + (px_int)(pcd->LeftSpacer + i * HorizontalInc),
                               offsety + pcd->TopSpacer + PX_Object_CoordinatesGetCoordinateHeight(pObject), 1, pcd->DashColor);
            }
        }
    }
    ...
    if (Divid > 1) {
        ...
        if (pcd->guidesShowMode == PX_OBJECT_COORDINATES_GUIDESSHOWMODE_ALL || pcd->guidesShowMode == PX_OBJECT_COORDINATES_GUIDESSHOWMODE_VERTICAL) {
            for (i = 1; i <= Divid; i++) {
                PX_GeoDrawLine(psurface, offsetx + (px_int)pcd->LeftSpacer, offsety + (px_int)(pObject->Height - pcd->BottomSpacer - i * VerticalInc),
                               offsetx + (px_int)(pcd->LeftSpacer + PX_Object_CoordinatesGetCoordinateWidth(pObject)),
                               offsety + (px_int)(pObject->Height - pcd->BottomSpacer - i * VerticalInc), 1, PX_COLOR(PX_OBJECT_COORDINATES_DEFAULT_DASH_RGB));
            }
        }
    }
}
...
static px_void PX_Object_CoordinatesDrawFlagText(px_surface *psurface, PX_Object *pObject) {
    ...
    if (Divid > 0) {
        ...
        for (i = 0; i <= Divid; i++) {
            ...
            PX_FontDrawText(psurface, offsetx + (px_int)(pcd->LeftSpacer + (i)*HorizontalInc),
                            offsety + (px_int)(pObject->Height - pcd->BottomSpacer + PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER + 2), text, pcd->FontColor,
    ...
    if (Divid > 0) {
        ...
        if (pcd->LeftTitleShow) {
            ...
            for (i = 0; i <= Divid; i++) {
                ...
                PX_FontDrawText(psurface, offsetx + pcd->LeftSpacer - 6, offsety + (px_int)(pObject->Height - pcd->BottomSpacer - (i)*VerticalInc - 6), text,
                                pcd->FontColor, PX_FONT_ALIGN_XRIGHT);
            }
        }
        ...
        if (pcd->RightTitleShow) {
            ...
            for (i = 0; i <= Divid; i++) {
                ...
                PX_FontDrawText(psurface, offsetx + (px_int)(pObject->Width - pcd->RightSpacer + PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER),
                                offsety + (px_int)(pObject->Height - pcd->BottomSpacer - (i)*VerticalInc - 6), text, pcd->FontColor, PX_FONT_ALIGN_XLEFT);
            }
        }
    }
}
...
static px_void PX_Object_CoordinatesDrawTitle(px_surface *psurface, PX_Object *pObject) {
    ...
    if (pcd->BottomTitle[0]) {
        PX_FontDrawText(psurface, offsetx + (px_int)(pObject->Width / 2), offsety + (px_int)(pObject->Height - pcd->BottomSpacer + 32), pcd->BottomTitle,
                        pcd->FontColor, PX_FONT_ALIGN_XCENTER);
    }
...
static px_void PX_Object_CoordinatesDrawDataInfo(px_surface *psurface, PX_Object *pObject, px_double *Horizontal, px_double *Vertical, px_int linewidth,
                                                 px_int Size, px_int Map, px_color Color) {
    ...
    switch (pcd->LineMode) {
        case PX_OBJECT_COORDINATES_LINEMODE_PILLAR: {
            ...
            for (i = 0; i < Size; i++) {
                ...
                if (Horizontal[i] > pcd->HorizontalRangeMax) break;
            }
        } break;
            ...
            for (i = 0; i < Size; i++) {
                if (Horizontal[i] >= pcd->HorizontalRangeMin) {
                    if (i > 0) {
                        ...
                        if (PX_isLineCrossRect(
                                PX_POINT((px_float)dx1, (px_float)dy1, 0), PX_POINT((px_float)dx2, (px_float)dy2, 0),
                                PX_RECT((px_float)pcd->LeftSpacer, (px_float)pcd->TopSpacer, (px_float)PX_Object_CoordinatesGetCoordinateWidth(pObject),
                                        (px_float)PX_Object_CoordinatesGetCoordinateHeight(pObject)),
                                &pt1, &pt2)) {
                            PX_GeoDrawLine(psurface, (px_int)(offsetx + pt1.x), (px_int)(offsety + pt1.y), (px_int)(offsetx + pt2.x), (px_int)(offsety + pt2.y),
                                           linewidth, Color);
                        }
                    }
                }
                if (Horizontal[i] > pcd->HorizontalRangeMax) {
                    if (i > 0) {
                        ...
                        if (PX_isLineCrossRect(
                                PX_POINT((px_float)dx1, (px_float)dy1, 0), PX_POINT((px_float)dx2, (px_float)dy2, 0),
                                PX_RECT((px_float)pcd->TopSpacer, (px_float)pcd->LeftSpacer, (px_float)PX_Object_CoordinatesGetCoordinateWidth(pObject),
                                        (px_float)PX_Object_CoordinatesGetCoordinateHeight(pObject)),
                                &pt1, &pt2))
                            PX_GeoDrawLine(psurface, (px_int)(offsetx + pt1.x), (px_int)(offsety + pt1.y), (px_int)(offsetx + pt2.x), (px_int)(offsety + pt2.y),
                                           linewidth, Color);
...
static px_void PX_Object_CoordinatesDrawData(px_surface *psurface, PX_Object *pObject) {
    ...
    if (pcd->bDataUpdatePainter) {
        for (i = 0; i < pcd->vData.size; i++) {
            ...
            if (pData->Visibled)
                PX_Object_CoordinatesDrawDataInfo(psurface, pObject, pData->MapHorizontalArray, pData->MapVerticalArray, pData->linewidth, pData->Size,
                                                  pData->Map, pData->Color);
        }
    }
}
static px_void PX_Object_CoordinatesDrawScaleDraging(px_surface *psurface, PX_Object *pObject) {
    ...
    if (pcd->DragingPoint.y < pcd->DragStartPoint.y && pcd->DragingPoint.x < pcd->DragStartPoint.x)
        PX_GeoDrawRect(psurface, offsetx + (px_int)pcd->DragStartPoint.x, offsety + (px_int)pcd->DragStartPoint.y, offsetx + (px_int)pcd->DragingPoint.x,
...
static px_void PX_Object_CoordinatesDrawHelpLine(px_surface *psurface, PX_Object *pObject) {
    ...
    if (pcd->HorizontalShow) {
        ...
        if (value > pcd->HorizontalRangeMin && value < pcd->HorizontalRangeMax) {
            ...
            PX_GeoDrawLine(psurface, (px_int)pObject->x + x, (px_int)(pObject->y + pObject->Height - pcd->BottomSpacer), (px_int)pObject->x + x,
                           (px_int)pObject->y + pcd->TopSpacer, (px_int)1, pcd->helpLineColor);
            // Draw text
            ...
            PX_FontDrawText(psurface, (px_int)(pObject->x + X - PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER * 1.5), (px_int)pObject->y + Y, text,
                            pcd->helpLineColor, PX_FONT_ALIGN_XLEFT);
        }
    }
    ...
    if (pcd->LeftTitleShow) {
        ...
        if (value > pcd->LeftVerticalRangeMin && value < pcd->LeftVerticalRangeMax) {
            ...
            PX_GeoDrawLine(psurface, (px_int)pObject->x + pcd->LeftSpacer, (px_int)pObject->y + y, (px_int)(pObject->x + pObject->Width - pcd->RightSpacer),
                           (px_int)pObject->y + y, 1, pcd->helpLineColor);
            // Draw text
            ...
            PX_FontDrawText(psurface, (px_int)pObject->x + X, (px_int)pObject->y + Y - PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER * 2 - 1, text,
                            pcd->helpLineColor, PX_FONT_ALIGN_XLEFT);
        }
    }
    ...
    if (pcd->RightTitleShow) {
        ...
        if (value > pcd->RightVerticalRangeMin && value < pcd->RightVerticalRangeMax) {
            ...
            PX_GeoDrawLine(psurface, (px_int)pObject->x + pcd->LeftSpacer, (px_int)pObject->y + y, (px_int)(pObject->x + pObject->Width - pcd->RightSpacer),
                           (px_int)pObject->y + y, (px_int)(1), pcd->helpLineColor);
    ...
    for (i = 0; i < pcd->vFlagLine.size; i++) {
        ...
        if (pflgl->XYshow & PX_OBJECT_COORDINATEFLAGLINE_XSHOW) {
            if (pflgl->X >= pcd->HorizontalRangeMin && pflgl->X <= pcd->HorizontalRangeMax) {
                ...
                PX_GeoDrawLine(psurface, (px_int)pObject->x + x, (px_int)((px_int)pObject->y + pObject->Height - pcd->BottomSpacer), (px_int)pObject->x + x,
                               (px_int)pObject->y + pcd->TopSpacer, (px_int)pflgl->LineWidth, pflgl->color);
                // Draw text
                ...
                PX_FontDrawText(psurface, (px_int)((px_int)pObject->x + X - PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER * 1.5), (px_int)pObject->y + Y, text,
                                pcd->FontColor, PX_FONT_ALIGN_XLEFT);
            }
        }
        ...
        if (pflgl->XYshow & PX_OBJECT_COORDINATEFLAGLINE_XSHOW) {
            if (pflgl->Y >= pcd->LeftVerticalRangeMin && pflgl->Y <= pcd->LeftVerticalRangeMax) {
                ...
                PX_GeoDrawLine(psurface, (px_int)pObject->x + pcd->LeftSpacer, (px_int)pObject->y + y,
                               (px_int)((px_int)pObject->x + pObject->Width - pcd->RightSpacer), (px_int)pObject->y + y, (px_int)(pflgl->LineWidth),
                               pflgl->color);
                // Draw text
                ...
                PX_FontDrawText(psurface, (px_int)pObject->x + X - 4 * PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER,
                                (px_int)pObject->y + Y - PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER, text, pcd->FontColor, PX_FONT_ALIGN_XLEFT);
            }
        }
        ...
        if (pflgl->XYshow & PX_OBJECT_COORDINATEFLAGLINE_YRSHOW) {
            if (pflgl->Y >= pcd->RightVerticalRangeMin && pflgl->Y <= pcd->RightVerticalRangeMax) {
                ...
                PX_FontDrawText(psurface, (px_int)pObject->x + X, (px_int)pObject->y + Y - PX_OBJECT_COORDINATES_DEFAULT_FLAGTEXT_SPACER, text, pcd->FontColor,
                                PX_FONT_ALIGN_XLEFT);
            }
        }
    }
...
px_void PX_Object_CoordinatesDrawMarkLine(px_surface *psurface, PX_Object *pObject) {
    ...
    if (pcd->MarkValueEnabled && pcd->OnMarkStatus) {
        if (pcd->MarkLineX != -1) {
            PX_GeoDrawLine(psurface, pcd->MarkLineX, pcd->TopSpacer, pcd->MarkLineX, (px_int)(pObject->Height - pcd->BottomSpacer), 1,
...
px_void PX_Object_CoordinatesRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    if (pcd->HorizontalShow) PX_Object_CoordinatesDrawFlagText(psurface, pObject);
    ...
    if (pcd->ScaleEnabled) PX_Object_CoordinatesDrawScaleDraging(psurface, pObject);
...
PX_Object *PX_Object_CoordinatesCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int Width, px_int Height) {
    ...
    PX_Object_CoordinatesSetMargin(&Coordinates, (px_int)(1.5f * PX_OBJECT_COORDINATES_DEFAULT_SPACER), (px_int)(1.5 * PX_OBJECT_COORDINATES_DEFAULT_SPACER),
                                   PX_OBJECT_COORDINATES_DEFAULT_SPACER, PX_OBJECT_COORDINATES_DEFAULT_SPACER);
    ...
    pObject =
        PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width, (px_float)Height, 0, PX_OBJECT_TYPE_COORDINATE, PX_Object_CoordinatesUpdate,
                          PX_Object_CoordinatesRender, PX_Object_CoordinatesFree, &Coordinates, sizeof(PX_Object_Coordinates));
...
static px_void PX_Object_FilterEditorDrawFrameLine(px_surface *psurface, PX_Object *pObject) {
    ...
    PX_GeoDrawLine(psurface, offsetx, offsety, offsetx + (px_int)(pObject->Width - 1), offsety, PX_OBJECT_FILTEREDITOR_DEFAULT_FRAMELINE_WIDTH,
                   pfe->borderColor);
    PX_GeoDrawLine(psurface, offsetx, offsety, offsetx, offsety + (px_int)(pObject->Height - 1), PX_OBJECT_FILTEREDITOR_DEFAULT_FRAMELINE_WIDTH,
                   pfe->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + pObject->Width - 1), offsety + (px_int)(pObject->Height - 1), offsetx, offsety + (px_int)pObject->Height - 1,
                   PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH, pfe->borderColor);
    PX_GeoDrawLine(psurface, (px_int)(offsetx + pObject->Width - 1), offsety + (px_int)(pObject->Height - 1), offsetx + (px_int)(pObject->Width - 1), offsety,
                   PX_OBJECT_COORDINATES_DEFAULT_FRAMELINE_WIDTH, pfe->borderColor);
}
...
static px_void PX_Object_FilterEditorDrawSelectDraging(px_surface *psurface, PX_Object *pObject) {
    ...
    PX_GeoDrawRect(psurface, (px_int)(offsetx + pfe->DragStartPoint.x), (px_int)(offsety + (px_int)pfe->DragStartPoint.y),
                   (px_int)(offsetx + (px_int)pfe->DragingPoint.x), (px_int)(offsety + (px_int)pfe->DragingPoint.y), PX_COLOR(96, 171, 81, 128));
}
...
static px_void PX_Object_FilterEditorDrawPt(px_surface *psurface, PX_Object *pObject) {
    ...
    for (i = 0; i < pfe->opCount - 1; i++) {
        PX_GeoDrawLine(psurface, (px_int)(oftx + pfe->pt[i].x), (px_int)(ofty + pfe->pt[i].y), (px_int)(oftx + pfe->pt[i + 1].x),
                       (px_int)(ofty + pfe->pt[i + 1].y), 2, pfe->ptColor);
    }
}
...
PX_Object *PX_Object_FilterEditorCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int Width, px_int Height, PX_OBJECT_FILTER_TYPE type) {
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width, (px_float)Height, 0, PX_OBJECT_TYPE_FILTEREDITOR, PX_NULL,
                                PX_Object_FilterEditorRender, PX_NULL, &FilterEditor, sizeof(PX_Object_FilterEditor));
...
px_void PX_Object_CheckBoxOnMouseLButtonDown(PX_Object *Object, PX_Object_Event e, px_void *user_ptr) {
    ...
    if (pcb) {
        if (PX_ObjectIsPointInRegion(Object, (px_float)x, (px_float)y)) pcb->state = PX_OBJECT_CHECKBOX_STATE_ONPUSH;
    }
}
...
px_void PX_Object_CheckBoxRender(px_surface *psurface, PX_Object *pObject, px_uint elpased) {
    ...
    PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                   (px_int)pObject->y + (px_int)pObject->Height - 1, pcb->BackgroundColor);
    switch (pcb->state) {
        case PX_OBJECT_BUTTON_STATE_NORMAL:
            PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                           (px_int)pObject->y + (px_int)pObject->Height - 1, pcb->BackgroundColor);
        ...
        case PX_OBJECT_BUTTON_STATE_ONPUSH:
            PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                           (px_int)pObject->y + (px_int)pObject->Height - 1, pcb->PushColor);
            break;
        case PX_OBJECT_BUTTON_STATE_ONCURSOR:
            PX_GeoDrawRect(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                           (px_int)pObject->y + (px_int)pObject->Height - 1, pcb->CursorColor);
            break;
    }

    if (pcb->Border) {
        PX_GeoDrawBorder(psurface, (px_int)pObject->x, (px_int)pObject->y, (px_int)pObject->x + (px_int)pObject->Width - 1,
                         (px_int)pObject->y + (px_int)pObject->Height - 1, 1, pcb->BorderColor);
    }
...
PX_Object *PX_Object_CheckBoxCreate(px_memorypool *mp, PX_Object *Parent, px_int x, px_int y, px_int Width, px_int Height, const char text[]) {
    ...
    pObject = PX_ObjectCreateEx(mp, Parent, (px_float)x, (px_float)y, 0, (px_float)Width, (px_float)Height, 0, PX_OBJECT_TYPE_CHECKBOX, PX_NULL,
                                PX_Object_CheckBoxRender, PX_NULL, &cbx, sizeof(cbx));
    if (!pObject) {
        return PX_NULL;
    }
...
px_void PX_Object_CheckBoxSetBackgroundColor(PX_Object *Object, px_color clr) { PX_Object_GetCheckBox(Object)->BackgroundColor = clr; }

px_void PX_Object_CheckBoxSetBorderColor(PX_Object *Object, px_color clr) { PX_Object_GetCheckBox(Object)->BorderColor = clr; }

px_void PX_Object_CheckBoxSetPushColor(PX_Object *Object, px_color clr) { PX_Object_GetCheckBox(Object)->PushColor = clr; }

px_void PX_Object_CheckBoxSetCursorColor(PX_Object *Object, px_color clr) { PX_Object_GetCheckBox(Object)->CursorColor = clr; }

px_void PX_Object_CheckBoxSetTextColor(PX_Object *Object, px_color clr) { PX_Object_GetCheckBox(Object)->TextColor = clr; }
