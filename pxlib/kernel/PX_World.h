...
typedef PX_Object *(*px_world_func_CreateObject)(PX_World *world, px_float x, px_float y, px_float z, px_float width, px_float height, px_float length,
                                                 px_void *user);
typedef struct {
    const px_char *name;
...
_LIMIT px_int PX_WorldSearchRegion(PX_World *world, px_float centerX, px_float centerY, px_float raduis, PX_Object *Object[], px_int MaxSearchCount,
