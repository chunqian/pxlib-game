...
px_void PX_LobbyOnGameStart(PX_Object *pObject, PX_Object_Event e, px_void *ptr) { PX_LobbyGameStart((PX_Lobby *)ptr); }
...
static px_void PX_LobbyStandRender_UserInfo(PX_Lobby *pDesc, px_dword elpased) {
    ...
    if (!pDesc->photo.surfaceBuffer) {
        ...
        PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, (px_int)pDesc->panel_userinfo.root->x + 48, (px_int)pDesc->panel_userinfo.root->y + 32 + 8, 28, 8,
                       PX_COLOR(255, 0, 0, 0), (px_int)pDesc->photo_loading_angle, (px_int)pDesc->photo_loading_angle + 60);
        PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, (px_int)pDesc->panel_userinfo.root->x + 48, (px_int)pDesc->panel_userinfo.root->y + 32 + 8, 28, 8,
                       PX_COLOR(255, 0, 0, 0), (px_int)pDesc->photo_loading_angle + 120, (px_int)pDesc->photo_loading_angle + 180);
        PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, (px_int)pDesc->panel_userinfo.root->x + 48, (px_int)pDesc->panel_userinfo.root->y + 32 + 8, 28, 8,
                       PX_COLOR(255, 0, 0, 0), (px_int)pDesc->photo_loading_angle + 240, (px_int)pDesc->photo_loading_angle + 320);
    } else {
        PX_TextureRender(&pDesc->pIns->runtime.RenderSurface, &pDesc->photo, (px_int)pDesc->panel_userinfo.root->x + 48,
                         (px_int)pDesc->panel_userinfo.root->y + 32 + 8, PX_TEXTURERENDER_REFPOINT_CENTER, PX_NULL);
    }
    ...
    if (pDesc->displayRankPt > (px_int)pDesc->userInfo.rank_pt) {
        if (pDesc->displayRankPt - pDesc->userInfo.rank_pt > 10000) {
            ...
            if (pDesc->displayRankPt > (px_int)pDesc->userInfo.rank_pt) pDesc->displayRankPt = pDesc->userInfo.rank_pt;
        }
    ...
    // userinfo border
    PX_GeoDrawBorder(&pDesc->pIns->runtime.RenderSurface, (px_int)pDesc->panel_userinfo.root->x, (px_int)pDesc->panel_userinfo.root->y,
                     (px_int)(pDesc->panel_userinfo.root->x + pDesc->panel_userinfo.root->Width - 1),
                     (px_int)(pDesc->panel_userinfo.root->y + pDesc->panel_userinfo.root->Height - 1), 3, PX_COLOR(255, 0, 0, 0));
    PX_ObjectRender(&pDesc->pIns->runtime.RenderSurface, pDesc->panel_userinfo.root, elpased);

    PX_ShapeRender(&pDesc->pIns->runtime.RenderSurface, &pDesc->panel_userinfo.shape_coin, (px_int)pDesc->panel_userinfo.root->x + 560,
                   (px_int)pDesc->panel_userinfo.root->y + 39, PX_TEXTURERENDER_REFPOINT_CENTER, PX_COLOR(255, 0, 0, 0));
    PX_ShapeRender(&pDesc->pIns->runtime.RenderSurface, &pDesc->panel_userinfo.shape_ticket, (px_int)pDesc->panel_userinfo.root->x + 680,
                   (px_int)pDesc->panel_userinfo.root->y + 39, PX_TEXTURERENDER_REFPOINT_CENTER, PX_COLOR(255, 0, 0, 0));
}

static px_void PX_LobbyStandRender_UserState(PX_Lobby *pDesc, px_dword elpased) {
    PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, pDesc->pIns->runtime.width / 2, pDesc->pIns->runtime.height / 2, 96, 16, PX_COLOR(255, 0, 0, 0),
                   (px_uint)pDesc->state_angle, (px_uint)pDesc->state_angle + 90);
    PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, pDesc->pIns->runtime.width / 2, pDesc->pIns->runtime.height / 2, 96, 16, PX_COLOR(255, 0, 0, 0),
                   (px_uint)pDesc->state_angle + 120, (px_uint)pDesc->state_angle + 210);
    PX_GeoDrawRing(&pDesc->pIns->runtime.RenderSurface, pDesc->pIns->runtime.width / 2, pDesc->pIns->runtime.height / 2, 96, 16, PX_COLOR(255, 0, 0, 0),
                   (px_uint)pDesc->state_angle + 240, (px_uint)pDesc->state_angle + 330);
...
px_void PX_LobbyUpdate_Packets_headBeatAck(PX_Lobby *pDesc, PX_UDP_ADDR addr, px_byte data[], px_int readsize) { pDesc->connection_elpased = 0; }
