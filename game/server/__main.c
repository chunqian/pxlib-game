...
int main(int argc, const px_char *argv[]) {
    ...
    if (StartupFilePath != PX_NULL && StartupFilePath[0] != 0) {
        ...
        if (fread(pPlayerNetDesc, 1, sizeof(PX_GameServerStartUp_PlayerNetInfo) * networkStartup.playerCount, pf) !=
            sizeof(PX_GameServerStartUp_PlayerNetInfo) * networkStartup.playerCount) {
            return 0;
        }
        ...
        if (fread(pPlayerDataDesc, 1, sizeof(PX_GameStartUp_PlayerDataDesc) * networkStartup.playerCount, pf) !=
            sizeof(PX_GameStartUp_PlayerDataDesc) * networkStartup.playerCount) {
            return 0;
        }
    ...
    if (!PX_ApplicationInitialize(&App, networkStartup.dataport, networkStartup.gameport, pPlayerNetDesc, pGameDesc, pPlayerDataDesc,
                                  networkStartup.playerCount)) {
        return 0;
    }
